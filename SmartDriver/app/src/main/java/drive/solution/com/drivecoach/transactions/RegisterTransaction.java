...
/**
 * Created by M1032185 on 11/30/2015.
 */
public class RegisterTransaction extends PostTransaction {

    private String regNum;

    JSONObject jsonObject;

    public RegisterTransaction(Context context,JSONObject jsonObject) {
        super(context);
