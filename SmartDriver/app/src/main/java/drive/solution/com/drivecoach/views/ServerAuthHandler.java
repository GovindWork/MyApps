...
//
///* Web client ID
// Client ID :475073148398-qjm429jfg7ebum7ft4fkua0f9mb4pla0.apps.googleusercontent.com
//Client secret:HH8OM5cmB-C7kg52n8_2Ej7I
//
//
//http://digitalpumpkin.cloudapp.net/VolvoWearablesApp/nativeservice/getscopes
//
//http://digitalpumpkin.cloudapp.net/VolvoWearablesApp/nativeservice/getaccesstoken
//
//
// */
//
...
// */
//public class ServerAuthHandler extends Activity implements GoogleApiClient.ServerAuthCodeCallbacks {
//
...
//    private static final String SERVER_BASE_URL = "http://digitalpumpkin.cloudapp.net";
//
//    // URL where the client should GET the scopes that the server would like granted
//    // before asking for a serverAuthCode.
//    private static final String SELECT_SCOPES_URL = SERVER_BASE_URL + "/VolvoWearablesApp/nativeservice/getscopes";
//
//    // URL where the client should POST the serverAuthCode so that the server can exchange
//    // it for a refresh token.
//    //private static final String EXCHANGE_TOKEN_URL = SERVER_BASE_URL + "/VolvoWearablesApp/nativeservice/exchangetoken";
//    private static final String EXCHANGE_TOKEN_URL = "http://digitalpumpkin.cloudapp.net" + "/VolvoWearablesApp/nativeservice/exchangetoken";
//    //private static final String EXCHANGE_TOKEN_URL = "https://172.22.244.165:8443/VolvoWearablesApp/nativeservice/exchangetoken";
//
//    private static final String Get_Access_Token = "http://digitalpumpkin.cloudapp.net/VolvoWearablesApp/nativeservice/getaccesstoken";
...
//    //Jaya
//
//    private boolean mServerHasToken;
...
//        // pdialog= new ProgressDialog(ServerAuthHandler.this);
...
//        Log.i(TAG, "Inside Exchangetoken loop");
//        //pdialog.show();
//        HttpClient httpClient = new DefaultHttpClient();
...
//
//        try {
//            Log.i(TAG, "Inside Get Access Token loop");
...
//            Log.i(TAG, "Code: " + statusCode);
//            Log.i(TAG, "Returning mServerHasToken" + responseBody);
////pdialog.dismiss();
...
//        mServerHasToken = Boolean.parseBoolean(responseBody);
//    }*/
//
//}